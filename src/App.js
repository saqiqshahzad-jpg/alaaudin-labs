...
import { Bot, Cpu, Zap, Mail, Globe } from 'lucide-react'; 
import './App.css';
      ...
      <motion.div className="bento-grid">
        ...
        <div className="card contact-card">
          <div className="social-links">
            ...
            {/* ✅ FIXED: Added rel="noreferrer" for security */}
            <a href="https://www.linkedin.com/in/muhammad-saqib-aichatbotdeveloper" target="_blank" rel="noreferrer">
            ...
            {/* ✅ FIXED: Changed "#" to "/" to avoid accessibility error */}
            <a href="/"><Globe /></a>
          </div>
